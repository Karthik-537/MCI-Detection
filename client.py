...
def load_data():
    unhealthy = pd.read_csv('C:\Users\91934\Desktop\ptbdb_abnormal.csv', header=None)
    healthy = pd.read_csv('C:\Users\91934\Desktop\ptbdb_normal.csv', header=None)
    ...
    print(unhealthy_x_train.shape)
    print(healthy_x_train.shape)
